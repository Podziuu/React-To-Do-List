...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#023E8A] flex items-center h-[70px]">
      ...
      {isNav && (
        <div className="absolute inset-0 bg-[#023E8A] flex justify-end items-end flex-col">
          <IoIosClose onClick={clickHandler} className="mr-2 cursor-pointer" color="white" size="50" />
